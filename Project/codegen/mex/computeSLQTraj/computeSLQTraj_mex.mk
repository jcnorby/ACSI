...
MAKEFILE = computeSLQTraj_mex.mk

include computeSLQTraj_mex.mki
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\computeSLQTraj"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\computeSLQTraj/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\computeSLQTraj/%.cpp
	$(CC) $(CPPFLAGS) "$<"
