 ...
 *
 * computeSLQTrajHoop_emxutil.h
 *
 * Code generation for function 'computeSLQTrajHoop_emxutil'
 *
 */

#ifndef COMPUTESLQTRAJHOOP_EMXUTIL_H
#define COMPUTESLQTRAJHOOP_EMXUTIL_H
...
/* End of code generation (computeSLQTrajHoop_emxutil.h) */
