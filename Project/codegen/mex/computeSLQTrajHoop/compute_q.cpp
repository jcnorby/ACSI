                 ...
                 real_T t_wp)
{
  ...
  return ((((((((((((((((in4[4] * 10.0 - in2[4] * 10.0) * (in4[4] - in2[4]) +
                        (in3[0] * 50000.0 - in5[0] * 50000.0) * (in3[0] - in5[0]))
                       + (in3[1] * 50000.0 - in5[1] * 50000.0) * (in3[1] - in5[1]))
                      + (in3[2] * 50000.0 - in5[2] * 50000.0) * (in3[2] - in5[2]))
                     + (in3[3] * 50000.0 - in5[3] * 50000.0) * (in3[3] - in5[3]))
                    + (in2[0] * 10.0 - in4[0] * 10.0) * (in2[0] - in4[0])) +
                   (in2[1] * 10.0 - in4[1] * 10.0) * (in2[1] - in4[1])) + (in2[2]
    * 10.0 - in4[2] * 10.0) * (in2[2] - in4[2])) + muDoubleScalarExp(a * a *
