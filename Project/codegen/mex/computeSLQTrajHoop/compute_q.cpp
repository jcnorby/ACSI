                 ...
                 real_T t_wp)
{
  ...
  return ((((((((((((((((in4[4] * 10.0 - in2[4] * 10.0) * (in4[4] - in2[4]) +
                        (in3[0] * 10000.0 - in5[0] * 10000.0) * (in3[0] - in5[0]))
                       + (in3[1] * 10000.0 - in5[1] * 10000.0) * (in3[1] - in5[1]))
                      + (in3[2] * 10000.0 - in5[2] * 10000.0) * (in3[2] - in5[2]))
                     + (in3[3] * 10000.0 - in5[3] * 10000.0) * (in3[3] - in5[3]))
