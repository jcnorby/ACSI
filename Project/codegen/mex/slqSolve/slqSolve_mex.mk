...
MAKEFILE = slqSolve_mex.mk

include slqSolve_mex.mki
...
SRC_FILES =  \
	...
	inv.cpp \
	warning.cpp \
	_coder_slqSolve_info.cpp \
	_coder_slqSolve_api.cpp \
	_coder_slqSolve_mex.cpp \
	slqSolve_emxutil.cpp \
	cpp_mexapi_version.cpp

MEX_FILE_NAME_WO_EXT = slqSolve_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\slqSolve"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\slqSolve/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\slqSolve/%.cpp
	$(CC) $(CPPFLAGS) "$<"
