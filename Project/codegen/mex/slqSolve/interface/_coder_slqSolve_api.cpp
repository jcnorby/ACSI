...
static void c_emlrt_marshallOut(const real_T u[1200], const mxArray *y);
...
static const mxArray *b_emlrt_marshallOut(const emxArray_real_T *u)
{
  const mxArray *y;
  const mxArray *m3;
  static const int32_T iv12[3] = { 0, 0, 0 };

  y = NULL;
  m3 = emlrtCreateNumericArray(3, iv12, mxDOUBLE_CLASS, mxREAL);
  ...
  const char_T *identifier))[3612]
{
  ...
  static void c_emlrt_marshallOut(const real_T u[1200], const mxArray *y)
{
  static const int32_T iv13[2] = { 4, 300 };

  emlrtMxSetData((mxArray *)y, (void *)&u[0]);
  emlrtSetDimensions((mxArray *)y, *(int32_T (*)[2])&iv13[0], 2);
}
...
static void emlrt_marshallOut(const real_T u[3612], const mxArray *y)
{
  static const int32_T iv11[2] = { 12, 301 };

  emlrtMxSetData((mxArray *)y, (void *)&u[0]);
  emlrtSetDimensions((mxArray *)y, *(int32_T (*)[2])&iv11[0], 2);
}
...
{
  real_T (*ret)[1200];
  static const int32_T dims[2] = { 4, 300 };
                    ...
                    *plhs[3])
{
  ...
  emxInit_real_T(&st, &K, 3, &b_emlrtRTEI, true);
