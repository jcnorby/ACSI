function [x,K,u, i_wp,t_wp, x_wp] = computeSLQTrajHoop(t_current,N,dt,x0,xf,umax,height_wp, x0_wp, dx0_wp, ddx0_wp, flag_wp)
...
%             1;1;0;0;0;0];
    ...
    dynamic_hoop_condition = (x_wp(3,i) >= height_wp && ddx0_wp(3) < 0);
